...
let modal = document.querySelector('.newsletter__popup2');

// Modalni ochish uchun funksiya
function openModal() {
    modal.classList.add('newsletter__show');
    document.body.classList.add('overlay__active');
}

// Modalni yopish uchun funksiya
function closeModal() {
    modal.classList.remove('newsletter__show');
    document.body.classList.remove('overlay__active');
}

// Modalni ochish uchun tugma
let openModalButton = document.querySelector('.variant__buy--now__btn');
openModalButton.addEventListener('click', openModal);

// Modalni yopish uchun tugma
let closeModalButton = document.querySelector('.newsletter__popup--close__btn');
